...
def main():
    ...
    #     victor.plan_to_joint_config(victor.right_arm_group, [random.random() * 2, random.random() * 2, random.random() * 2, random.random() * 2, random.random() * 2, random.random() * 2, random.random() * 2])
    #     victor.plan_to_joint_config(victor.left_arm_group, [random.random(), random.random(), random.random(), random.random(), random.random(), random.random(), random.random()])
    #     rospy.sleep(0.1)
